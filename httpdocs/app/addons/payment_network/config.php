...
fn_define('PAYMENT_NETWORK_ENDPOINT_HOSTED', 'https://gateway.cardstream.com/hosted/');
fn_define('PAYMENT_NETWORK_ENDPOINT_HOSTED_MODAL', 'https://gateway.cardstream.com/hosted/modal/');
fn_define('PAYMENT_NETWORK_ENDPOINT_HOSTED_DIRECT', 'https://gateway.Cardstream.com/direct/');
